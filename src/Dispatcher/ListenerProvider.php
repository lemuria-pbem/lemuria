...
class ListenerProvider implements ListenerProviderInterface
{
	...
	public function addListener(AbstractEvent $event, callable $listener): static {
	...
	public function removeListener(AbstractEvent $event, callable $listener): bool {
