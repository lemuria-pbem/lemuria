...
class OctagonalMapTest extends Base
{
	...
	public function getDirection(): void {
		...
		$way[Direction::Northeast] = new LocationMock(3);
		$this->assertSame(Direction::North, $map->getDirection($way));

		$way[Direction::Southwest] = new LocationMock(4);
		$this->assertSame(Direction::Northwest, $map->getDirection($way));

		$way[Direction::Southwest] = new LocationMock(5);
		$this->assertSame(Direction::West, $map->getDirection($way));

		$way[Direction::Southeast] = new LocationMock(6);
